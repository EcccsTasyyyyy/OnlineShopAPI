...
public interface IProductRepository : IRepository<ProductModel>
{
    ...
    IEnumerable<ProductModel> SortProducts(SortDTO sortDTO, IEnumerable<ProductModel> products);
    //IEnumerable<ProductModel> PaginateProducts(PaginationDTO paginationDTO, IEnumerable<ProductModel> products);
    IEnumerable<ProductModel> PaginateProducts(PaginationDTO paginationDTO);
}